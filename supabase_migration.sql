-- Создание таблиц для World Flag Battle
...
-- Обычные индексы
CREATE INDEX IF NOT EXISTS "Pixel_countryId_idx" ON "Pixel"("countryId");
CREATE INDEX IF NOT EXISTS "Pixel_placedBy_idx" ON "Pixel"("placedBy");
